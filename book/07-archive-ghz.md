...
> **【给普通读者 · 这幅图在说什么】**
>
> - **人话词解**：**GHZ** 是三位物理学家姓氏（Greenberger、Horne、Zeilinger）的缩写；可以把它想成**三人版的「谁的小抄对不上号」**：若坚持「每人在测量前就有固定答案、且不能隔空商量」，会推出**自相矛盾**。
> - **这档案解决什么**：Bell 常要**攒很多数据**看平均；GHZ 把矛盾挤到**更锋利**的逻辑结构里。读完你应知道：**被否定的具体是哪类「预先赋值」故事**，而不是笼统骂「量子骗人」。
> - **教科书常识**：在标准量子框架里，多体纠缠可以出现**非经典关联**；**Mermin** 等用更白话的逻辑帮助展示矛盾。
> - **本书立场**：泡泡/栅格是**局域递推**直觉；档案说明**哪一步会和标准 GHZ 叙事顶牛**。后面 **in-silico** 章是**电脑里的协议游戏**，**不能**顶替真实实验室原始迹。
> - **和物理学家们**：**不宣称**「GHZ 实验错了」；作者关心的是**模型类**与**陈述边界**。
> - **你需要会代码吗**：**不需要**。
...
>
> - **In plain words**: **GHZ** is three physicists’ initials (Greenberger, Horne, Zeilinger); think of it as **a three-person “answer-sheet contradiction.”** If everyone has a fixed answer before measurement and cannot whisper across distance, you can derive a **flat contradiction**.
> - **What this archive does**: Bell often needs **many trials** to see an average; GHZ squeezes the clash into a **sharper** logical shape. After reading, you should know **which “predetermined outcomes” story is ruled out**, not just “quantum is weird.”
> - **Textbook baseline**: Standard quantum mechanics allows **nonclassical many-body correlations**; **Mermin** and others gave especially clear popular expositions.
> - **This book’s stance**: Bubble / grid is **local update** intuition; the archive pins **where that collides with the standard GHZ story.** Later **in-silico** chapters are **protocol games on a computer** — **not** replacements for raw lab traces.
> - **For working physicists**: **No claim** that “GHZ experiments are wrong”; the author cares about **model classes** and **statement boundaries**.
> - **Code required?** **No.**
