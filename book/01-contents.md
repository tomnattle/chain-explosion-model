...
15. **第15章**　没通过的测量：诚实记录  
    *Ch.15 · What failed: an honest record*

---

## 第三部分 · Part III　设想 · Possibilities

16. **第16章**　经典光力学计算路径的设想  
    *Ch.16 · A classical optical computing pathway*

17. **第17章**　涟漪动力系统的设想  
    *Ch.17 · A ripple-based propulsion concept*
...
**存档 · Archive**  
序言与目录在全文优化前的快照见 `存档/preface-v1.0.md` 与 `存档/contents-v1.0.md`。根目录 `00-preface.md`、`01-contents.md` 为当前版；**若需旧章号（第二部分止于第9章）请对照 `存档/contents-v1.0.md`。**
