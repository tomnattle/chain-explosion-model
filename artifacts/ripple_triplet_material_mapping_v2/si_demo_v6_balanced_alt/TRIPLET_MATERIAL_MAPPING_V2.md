...
- rows: `5`
- n(MAE): `9.76996262e-16`
- mean(mu_fit): `275.831969`
...
- weights: w_n=1.0, w_eta_target=0.05, w_smooth_mu=0.1, w_smooth_rho=1.0, w_smooth_eta=1.0
- priors: w_mu_prior=1.0, w_rho_prior=0.001, mu_prior_scale=10.0, rho_prior_scale=40.0
